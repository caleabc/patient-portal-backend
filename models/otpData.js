...
let otpDataSchema = new mongoose.Schema({
  ...
  phoneNumber: { type: String, unique: true, required: true}, // Example. "+639123456789"
  otps: [{ type: Number, required: true }],
  createdAt: { type: Date, default: Date.now, index: { expires: '720h' } } // MongoDB will automatically delete the document 30 days after it was created. No need to save the OTP permanently
});
